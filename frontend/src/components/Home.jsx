      ...
      <div className="col-md-3">
        <div className="card m-2">
          ...
          <div className="card-body">
            <h3>{laptop.name}</h3>
            <h6>
              {laptop.address}, {laptop.location}
            </h6>
      ...
      <div className="background">
        <div className="opacity">
          <div className="container text-center">
            <h1 className="pt-4 text-white heading">
              Find your home with <span class="fw-bold">Homify</span>
            </h1>
        ...
        <div className="row">
          <Slider {...settings}>
            <div className="col m-2">
              <Link
                to="/browser?selectedType=Hostel"
            ...
            <div className="col m-2">
              <Link
                to="/browser?selectedType=Shared Apartments"
                className="text-decoration-none text-black"
              >
                <img
                  className="m-2 mx-auto"
                  width={250}
                  src="./Assets/Apartments.jpeg"
                  alt="Hey"
                />
                <h5>Apartments</h5>
              </Link>
            ...
            <div className="col m-2">
              <Link
                to="/browser?selectedType=Flat"
                className="text-decoration-none text-black"
              >
                <img
                  className="m-2 mx-auto"
                  width={250}
                  src="./Assets/Hostels.jpeg"
                  alt="Hey"
                />
                <h5>Flats</h5>
              </Link>
